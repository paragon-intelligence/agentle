...
def observe[**P](
    func: Callable[P, Coroutine[Any, Any, Generation[Any]]],
) -> Callable[P, Coroutine[Any, Any, Generation[Any]]]:
    """
    ...
    async def wrapper(*args: P.args, **kwargs: P.kwargs) -> Generation[Any]:
