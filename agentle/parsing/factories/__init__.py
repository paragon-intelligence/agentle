...
Available factories:
- audio_description_agent_factory: Creates an agent for audio file description and transcription
- visual_description_agent_factory: Creates an agent for analyzing and describing visual media
...
Example usage:
```python
from agentle.parsing.factories import audio_description_agent_factory
